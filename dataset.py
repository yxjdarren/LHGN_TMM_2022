...
class MtvDataset():
    def __init__(self, args):
        assert args.data in ['3sourcePartial', 'ADNI', 'animal', 'cub', 'hand', 'orl', 'pie', 'yale', '3source', 'politics', 'football', 'Scene', 'LandUse', 'Caltech'],  \
                            'This data not support.'
        self.args = args
        data_dct = {
            '3sourcePartial': '3sources_416sample.mat',
            'ADNI': 'ADNI_3classes.mat',
            'animal': 'mal.mat',
            'cub': 'cub_googlenet_doc2vec_c10.mat',
            'hand': 'handwritten.mat',
            'orl': 'ORL_mtv.mat',
            'pie': 'PIE_face_10.mat',
            'yale': 'yaleB_mtv.mat',
            '3source': 'Tao-3source_double.mat',
            'politics': 'politicsie_9view.mat',
            'football': 'football_9view.mat',
            'Scene': 'Scene-15.mat',
            'LandUse': 'LandUse-21.mat',
            'Caltech': 'Caltech101-20.mat'
        }
